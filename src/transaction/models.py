...
class Transaction(models.Model):
    ...
    account_type = models.ForeignKey(Item, on_delete=models.DO_NOTHING, related_name='account_type')
    category = models.ForeignKey(Item, on_delete=models.DO_NOTHING, related_name='transaction_category')
